...
<section class="page-section" id="contact">
    <div class="container">
        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src=<?= base_url('assets/img/app.gif') ?> alt="..." aria-label="IBM Logo" style="border-radius: 5rem;max-width: 100%;height:600px;/></a>
<!-- Footer-->
<footer class=" footer py-4">
            <div class="container">
                <div style="text-align:center">
                    <div class="row align-items-center ">
                        <div class="text-align:center">Copyright &copy; Myroket 2022</div>
